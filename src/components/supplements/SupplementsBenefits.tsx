  ...
  return (
    <section className="py-20 bg-gradient-to-br from-bbd-charcoal/20 via-bbd-black to-bbd-charcoal/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Trust Indicators - Mobile: Separate compact cards, Desktop: Original horizontal */}
        <div className="mt-16 text-center">
          {/* Mobile: Compact separate cards matching benefit cards width */}
          <div className="block sm:hidden grid grid-cols-1 gap-3 max-w-md mx-auto px-4">
            <div className="flex items-center bg-bbd-charcoal/30 rounded-lg px-4 py-3 border border-bbd-charcoal/50">
              <svg className="w-6 h-6 text-bbd-orange mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
              </svg>
              <span className="text-sm font-medium text-bbd-ivory/80">Third-Party Tested</span>
            </div>
            <div className="flex items-center bg-bbd-charcoal/30 rounded-lg px-4 py-3 border border-bbd-charcoal/50">
              <svg className="w-6 h-6 text-bbd-orange mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
              <span className="text-sm font-medium text-bbd-ivory/80">No Artificial Fillers</span>
            </div>
            <div className="flex items-center bg-bbd-charcoal/30 rounded-lg px-4 py-3 border border-bbd-charcoal/50">
              <svg className="w-6 h-6 text-bbd-orange mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-medium text-bbd-ivory/80">Made in USA</span>
            </div>
          </div>
          ...
          <div className="hidden sm:block">
            <div className="inline-flex items-center space-x-8 bg-bbd-charcoal/30 rounded-full px-8 py-4 border border-bbd-charcoal/50">
              <div className="flex items-center text-bbd-ivory/70">
                <svg className="w-5 h-5 text-bbd-orange mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                </svg>
